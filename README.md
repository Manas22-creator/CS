1 A.Use the following tools to perform footprinting and 
reconnaissance 
...
2 A. Use Proxy Workbench to see the data passing through it and 
...
iv. LANState Pro 
 ...
 i. Alkasir 
ii. Tails OS 
iii. Use Scanning Tools for Mobile – Network Scanner, Fing – 
...
6 A. Use Social Engineering Toolkit on Kali Linux to perform Social 
...
8 A. Protect the Web Application using dotDefender.    
 B. Demonstrate the following tools to perform SQL 
Injection: 
 i. Tyrant SQL 
ii. Havij 
iii. BBQSQL 
